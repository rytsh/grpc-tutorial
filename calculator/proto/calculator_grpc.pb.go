...
func (x *calculatorPrimeClient) Recv() (*PrimeResponse, error) {
	m := new(PrimeResponse)
...
func (c *calculatorClient) Avg(ctx context.Context, opts ...grpc.CallOption) (Calculator_AvgClient, error) {
	stream, err := c.cc.NewStream(ctx, &Calculator_ServiceDesc.Streams[1], "/calculator.Calculator/Avg", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *calculatorPrimeServer) Send(m *PrimeResponse) error {
